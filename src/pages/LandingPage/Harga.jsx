    ...
    <div id="harga" className="w-full pt-[75px] pb-[30px] px-4 bg-white">
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 mt-1.5">
        ...
        <FlipCard
          frontContent={
            <>
              <h2 className="text-2xl item poppins-medium px-6 md:pt-[89px]">
                Demo
              </h2>
              ...
              <div className="flex justify-center">
                <Button
                  variant="secondary"
                  className="lg:w-[300px] my-6 px-6 py-3"
                >
                  Mulai Sekarang
                </Button>
              </div>
          ...
          backContent={
            <>
              ...
              <p className="text-[15px] text-[#828282] poppins-medium px-6">
                Paket Demo cocok untuk Anda yang ingin mencoba layanan kami
                tanpa biaya. Termasuk fitur dasar dan akses ke komunitas
                eksklusif.
              </p>
              <div className="m-[13px] mx-8">
                <div className="flex items-center gap-[10px]">
        ...
        <FlipCard
          ...
          backContent={
            <>
              ...
              <p className="text-[15px] text-[#828282] poppins-medium px-6">
                Paket Standard menawarkan fitur yang lebih lengkap dengan harga
                terjangkau. Ideal untuk bisnis kecil dan individu.
              </p>
              <div className="m-[13px] mx-8">
                <div className="flex items-center gap-[10px]">
                  <AiOutlineCheckCircle className="w-6 h-6 text-[#bfd2ff]" />
        ...
        <FlipCard
          frontContent={
            <>
              ...
              <p className="text-3xl poppins-medium mx-6 mt-[46px]">
                Rp 70.000
              </p>
              <div className="flex justify-center">
                <Button
          ...
          backContent={
            <>
              ...
              <p className="text-[15px] text-[#828282] poppins-medium px-6">
                Paket Mantab menyediakan fitur premium dan dukungan 24/7 untuk
                Anda yang membutuhkan kapasitas dan kinerja tinggi. Solusi
