      ...
      <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-start gap-8">
        <div className="flex flex-col justify-center items-start min-h-100 mx-auto">
          <div className="w-[350px] lg:w-[600px]">
            ...
            <p>
              Apabila Anda memiliki pertanyaan, memerlukan bantuan, atau ingin
              mendapatkan informasi lebih lanjut mengenai layanan dan produk
              kami, jangan ragu untuk menghubungi kami.
            </p>
          </div>
          <form
            id="contact_data"
            className="max-w-[600px] w-full bg-white rounded-[8px]"
          >
        ...
        <div className="flex flex-col items-center lg:items-end mt-10 mx-auto">
          ...
          <p className="mt-4">
            Instagram: <span className="font-medium">@yourinstagram</span>
          </p>
          <p className="mt-2">
            Email: <span className="font-medium">example@example.com</span>
          </p>
          <p className="mt-2">
            Phone: <span className="font-medium">+62 123 4567</span>
          </p>
          <p className="mt-2">
            WhatsApp: <span className="font-medium">+62 123 4567</span>
          </p>
        </div>
      </div>
    </div>
